...
@Controller
@RequestMapping("/Warehouseman")//审核人控制层
public class WarehousemanController {
    @Autowired
    private WarehousemanService warehousemanService;
    @RequestMapping(value = "/login")
    public String login(Warehouseman warehouseman, Model model, HttpSession session, HttpServletRequest request) {
        // 通过账号和密码查询用户

        Warehouseman ad = warehousemanService.findWarehouseman(warehouseman);
